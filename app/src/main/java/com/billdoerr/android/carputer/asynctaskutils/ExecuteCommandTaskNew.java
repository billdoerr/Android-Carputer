 ...
 *
 */
public class ExecuteCommandTaskNew extends AsyncTask<TaskRequest, Void, TaskResult> {

    private static final String TAG = "ExecuteCommandTaskNew";
    ...
    protected TaskResult doInBackground(TaskRequest... params) {
        ...
        try {
            ...
            utils.initialize(taskParams.nodes.get(0).getIp(), taskParams.nodes.get(0).getSSHPort(),
                    taskParams.nodes.get(0).getUser(), taskParams.nodes.get(0).getPassword());
